...
function ScoreTable({ wins, losses, round }: IScoreTable) {
  const [isReactedCharacterChange, setIsReactedCharacterChange] =
  ...
  return (
    <div className="score-table">
      <div className="round-counter">
        <h2 className="rick-and-morty-font">
          {" "}
          {(roundCount < 4 && roundCount) || 3}
          round
        </h2>
      ...
      <div className="comment-block">
        ...
        <div className="comment rick-and-morty-font">{comment}</div>
      </div>
      ...
      <div className="emotions-blosk">
        ...
        <Button
          text={arrowsRotate}
          onClick={() => setIsReactedCharacterChange((prev) => !prev)}
